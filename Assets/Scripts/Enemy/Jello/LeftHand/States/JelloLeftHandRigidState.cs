...
namespace QT.InGame
{
    [FSMState((int) JelloLeftHand.States.Rigid)]
    public class JelloLeftHandRigidState : FSMState<JelloLeftHand>
    {
        ...
        public JelloLeftHandRigidState(IFSMEntity owner) : base(owner)
        {
        ...
        public override void UpdateState()
        {
            ...
            {
                _ownerEntity.ChangeState(JelloLeftHand.States.Dead);
            }
        }
