...
namespace QT.Util.Flags
{
    ...
    [CustomPropertyDrawer(typeof(ChargeAtkPierce))]
    // 커스텀 플래그 에디터 출처 https://www.kevin-agwaze.com/tip-of-the-week-4-working-with-bitflag-enums-in-unity-editor/
            ...
            return new ReorderableList(activeEnumNames, typeof(string), false, true, true, true)
            {
                drawHeaderCallback = rect =>
                {
                    EditorGUI.LabelField(rect,
                        new GUIContent(serializedProperty.displayName, "EnumType: " + EnumType.Name));
                },
                drawElementCallback = (rect, index, isActive, isFocused) =>
                {
                    ...
                    EditorGUI.LabelField(
                        ...
                        new GUIContent(enumNameToDisplayName[activeEnumNames[index]],
                            enumNameToTooltip[activeEnumNames[index]]),
                        EditorStyles.label);
                },
